...
当前发布基线：App `2.1.5` / Tool `2.2.5`。本版本重点：`search_email` 改为实时 Gmail 检索并透传列表工作流状态、附件下载优先 Host upload 并修复 APS reverse-RPC 路由、邮件详情固定滚到底部与正文/附件展示修正，以及联系人头像预热与 AI 消息渲染稳定性。
