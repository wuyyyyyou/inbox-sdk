...
| 端 | 版本 | 权威文件 |
| --- | --- | --- |
| App | `2.2.2` | `anna-inbox/app.json` |
| Tool | `2.3.2` | `inbox-tool/manifest.json`（同步 `pyproject.toml`、`executa.json`、`min_version`） |
...
- [2.3.2 架构与发布基线](anna-inbox/docs/2.3.2架构与发布基线.md)
