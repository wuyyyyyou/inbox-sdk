...
| 端 | 版本 | 权威文件 |
| --- | --- | --- |
| App | `2.2.7` | `anna-inbox/app.json` |
| Tool | `2.3.7` | `inbox-tool/manifest.json`（同步 `pyproject.toml`、`executa.json`、`min_version`） |
...
- [2.3.7 架构与发布基线](anna-inbox/docs/2.3.7架构与发布基线.md)
