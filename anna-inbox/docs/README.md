...
当前基线：**App `2.1.3` / Tool `2.2.3`**（版本解耦）。

## 当前实现

- [2.2.3 架构与发布基线](2.2.3架构与发布基线.md)
...
- [AI 对话本地 Router 与白名单工具](AI对话本地Router与白名单工具设计.md)（阶段 A+B+C 已落地）
- [AI 侧栏 Sampling → Sessions 改造方案](AI侧栏Sampling转Sessions改造方案.md)（方案设计，未开工）
- [Ask 链路](Ask链路重构方案.md)
